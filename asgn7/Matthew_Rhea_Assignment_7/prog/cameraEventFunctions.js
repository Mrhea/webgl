...
function movementTransform(transformType) {
  ...
  switch(transformType) {
    case 1:  // Forward 
      ...
      scene.camera.Center.elements[2] += scene.camera.Center.elements[2]*dT;
      break;
    case 2:  // Strafe right
      scene.camera.Eye.elements[0] += scene.camera.Side.elements[0]*(dT/5);
      scene.camera.Center.elements[0] += scene.camera.Side.elements[0]*(dT/5);
