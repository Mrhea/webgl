...
class TiltedCube extends Geometry {
  ...
  /**
   * Unpacks the color coordinates from pixel color map into cube vertices
   * 
   * @param {array} color_map Array of Vec3 objects containing color data
   * @param {number} imageSize Pixel length of texture image
   */
  generateColorCoordinatesFromMap(color_map, imageSize) {
