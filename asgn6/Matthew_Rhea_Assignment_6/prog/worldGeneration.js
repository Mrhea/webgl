...
async function generateWorld() {
  ...
  // var OBJ_POSITION = [0, 0, 0];
  var TEXLocation = 'external/textures/cat_diff.jpg';
  var OBJLocation = 'external/OBJ/cat.obj';
  loadOBJFile(OBJLocation, TEXLocation, 0.0, 1.0, 1.0);
  OBJ_POSITION = [5, 0, 0];
  TEXLocation = 'external/textures/TeapotTex.png';
  OBJLocation = 'external/OBJ/teapot.obj';
  loadOBJFile(OBJLocation, TEXLocation, 2.0, 1.0, 1.0);

  // Paths to height and color mapping textures
  var heightPath = 'external/textures/height_Map.png';
  var colorPath = 'external/textures/color_Map.png';
