 ...
 */
  ...
  */
  constructor(size, centerX, centerY, centerZ, height) {
    ...
    this.dataCounts[1] = 0; 
    // console.log('IN CUBE DATA COUNT: ' + this.dataCounts); // Error here for colors
    /*****************************************/
  ...
  render() {
    ...
    sendAttributeDataToGLSL(this.dataArray, 'Colored', this.dataCounts, ['a_Position', 'a_Color', 'a_Normal']);
